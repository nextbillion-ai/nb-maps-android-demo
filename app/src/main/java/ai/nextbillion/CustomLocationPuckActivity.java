...
public class CustomLocationPuckActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_location_puck);
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            ...
            permissionsManager = new PermissionsManager(new PermissionsListener() {
                ...
                public void onExplanationNeeded(List<String> permissionsToExplain) {
                    Toast.makeText(CustomLocationPuckActivity.this, "You need to accept location permissions.",
                ...
                public void onPermissionResult(boolean granted) {
                    if (granted) {
                        mapView.getMapAsync(CustomLocationPuckActivity.this);
                    } else {
                        finish();
                    }
                }
    ...
    private void toggleLocationComponentStyle() {
        if (nextbillionMap == null) {
            return;
        }
